...
Sub ExportToPDFAndEmailMultAll()
    Dim ws As Worksheet
    ...
    Set ws = ThisWorkbook.Sheets("Quo (Mult) All")
...
Sub RecordQuoteDetails(ByVal pdfFileName As String)
    ...
    Set quoSheet = ThisWorkbook.Sheets("Quo (Mult) All")
...
Sub send_email_signature(ByVal pdfFileName As String)
    ...
    ' Set reference to the worksheet
    Set sh = ThisWorkbook.Sheets("Quo (Mult) All")
