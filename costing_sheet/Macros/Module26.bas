...
Sub ExportToPDFAndEmailMultProd()
    Dim ws As Worksheet
    ...
    Set ws = ThisWorkbook.Sheets("Quo (Mult) Prod")
...
Sub RecordQuoteDetails(ByVal pdfFileName As String)
    ...
    Set quoSheet = ThisWorkbook.Sheets("Quo (Mult) Prod")
...
Sub send_email_signature(ByVal pdfFileName As String)
    ...
    ' Set reference to the worksheet
    Set sh = ThisWorkbook.Sheets("Quo (Mult) Prod")
